      ...
      <div class="border rounded-md relative">
        <div class="flex items-center justify-between gap-2 bg-[#F9FAFB] py-4 px-4 rounded-md">
          <div class="flex items-center gap-2">
            <div class="h-10 w-10 bg-teal-600 text-white rounded-md text-center object-center place-content-center text-base">
              <svg
...
<div class="p-4 divide-y" key={income.id}>
          <div class="flex justify-between items-center py-2 relative group cursor-pointer">
            <div>
              ...
              <p class="text-xs text-gray-600">{income.date}</p>
            </div>
            <div class="flex items-center gap-2">
              ...
              <div class="translate-x-5 group-hover:translate-x-0 opacity-0 group-hover:opacity-100 absolute right-0 top-1/2 -translate-y-1/2 transition-all">
                ...
                <button class="hover:text-red-600" role="button" title="Delete" onClick={ () => onDelete(income.id)}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
                    height="18"
